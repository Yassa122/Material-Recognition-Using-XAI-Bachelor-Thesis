...
y = combined_data[["MolWt", "LogP", "NumRotatableBonds", "NumAtoms"]]  # Target properties
...
new_smiles_data = pd.read_csv("tested_combined_molecular_data.csv")  # Replace with your new SMILES dataset
...
new_smiles_data["Predicted_NumRotatableBonds"] = new_predictions[:, 2]  # Predicted number of rotatable bonds
new_smiles_data["Predicted_NumAtoms"] = new_predictions[:, 3]  # Predicted number of atoms
