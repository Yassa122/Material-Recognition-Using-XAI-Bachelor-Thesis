...
if "NumAtoms" not in math_based_df.columns or "Property_2" not in predicted_df.columns:
    print("NumAtoms or Property_2 column is missing.")
else:
    # Metrics for Property_2 (NumAtoms)
    mae_property_2 = mean_absolute_error(
        math_based_df["NumAtoms"], predicted_df["Property_2"]
    )
...
if "LogP" not in math_based_df.columns or "Property_3" not in predicted_df.columns:
    print("LogP or Property_3 column is missing.")
else:
    # Metrics for Property_3 (LogP)
    mae_property_3 = mean_absolute_error(
        math_based_df["LogP"], predicted_df["Property_3"]
    )
...
overall_mae = mean_absolute_error(
    math_based_df[["NumAtoms", "LogP"]], predicted_df[["Property_2", "Property_3"]]
)
...
r2_property_2 = r2_score(math_based_df["NumAtoms"], predicted_df["Property_2"])
r2_property_3 = r2_score(math_based_df["LogP"], predicted_df["Property_3"])
